...
class GUI(QtGui.QWidget, threading.Thread, QObject):
    item = None
    previous = ''
    running = True
    sleep_interval = 0.05
    ...
    def __init__(self):
        ...
        #QtGui.QWidget.__init__(self, None, Qt.WindowStaysOnTopHint)
        QObject.connect(self,SIGNAL("show_in_gui"),self.show_in_gui)
        self.start()
        self.initUI()
